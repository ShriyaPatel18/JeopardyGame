 ...
 * @author spate8
 */
public class RightNow extends javax.swing.JFrame {

    /**
     * Creates new form RightNow
     */
    public RightNow() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("display points");
        ...
        jButton1.setText("<html> Go back to <br> game page");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RightNow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
